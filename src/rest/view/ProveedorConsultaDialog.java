...
public class ProveedorConsultaDialog extends JDialog implements GestionObserver {
    ...
    public ProveedorConsultaDialog(Frame parent, Controller ctrl){
        super(parent, true);
        this.ctrl = ctrl;
    ...
    private void initGUI() {
        ...
        consulta.addActionListener(e-> {
            ...
            new ProveedorConsultaEvent(Utils.getWindow(this),ctrl,selectedProvID);
        }
        );
