...
public class ProveedorModificarDiaglog extends JDialog implements GestionObserver {
    ...
    public ProveedorModificarDiaglog(Frame parent, Controller ctrl){
        super(parent, true);
        this.ctrl = ctrl;
    ...
    private void initGUI() {
        ...
        modificar.addActionListener(e-> {
            ...
            new ProveedorModificarEvent(Utils.getWindow(this), ctrl, selectedProvID);
        });
    ...
    private void updateProveedorModel(List<Proveedor> proveedorList) {
